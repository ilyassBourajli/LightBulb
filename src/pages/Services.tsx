          ...
          <div className="relative w-full flex flex-col items-center justify-center gap-8 z-20 px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="flex items-center gap-8 mb-8 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-yellow-400">{t('services.professional_service')}</div>
                <div className="text-sm md:text-base text-white/80">{t('services.professional_service_description')}</div>
              </div>
              <div className="w-px h-8 bg-white/30"></div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-yellow-400">{t('services.additional_services')}</div>
                <div className="text-sm md:text-base text-white/80">{t('services.additional_services_description')}</div>
              </div>
              <div className="w-px h-8 bg-white/30"></div>
              <div className="text-center">
                <div className="text-2xl md:text-3xl font-bold text-yellow-400">{t('services.emergency_service')}</div>
                <div className="text-sm md:text-base text-white/80">{t('services.emergency_service_description')}</div>
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
              ...
              >
                <span>{t('projects.our_realizations')}</span>
                <ArrowRight className="w-6 h-6 group-hover:translate-x-2 transition-transform duration-300" />
              </Link>
            </div>
          </div>
        ...
        <section id="services" className="w-full px-4 sm:px-6 lg:px-8 py-16 bg-white">
          ...
          {mainServices.map((service, index) => (
            ...
            >
                  ...
                  <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-2 group-hover:text-yellow-600 transition-colors duration-300">
                    {service.title}
                  </h2>
                  <p className="text-base sm:text-lg text-yellow-800 mb-4 group-hover:text-yellow-700 transition-colors duration-300">
                    {service.subtitle}
                  </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
              ...
              <div className="bg-white border-2 border-yellow-300 rounded-2xl p-8 sm:p-12 lg:p-14 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-blue-400/60 group hover:-translate-y-2">
                <div className="text-center">
                  ...
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-800 mb-4 group-hover:text-red-600 transition-colors duration-300">
                    Urgence 24h/7j
                  </h2>
              ...
              <div className="bg-white border-2 border-yellow-300 rounded-2xl p-8 sm:p-12 lg:p-14 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:shadow-blue-400/60 group hover:-translate-y-2">
                <div className="text-center">
                  ...
                  <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-gray-800 mb-4 group-hover:text-yellow-600 transition-colors duration-300">
