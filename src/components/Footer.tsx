        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-12 px-8 sm:px-12 lg:px-20">
          ...
          <div className="lg:col-span-4 flex flex-col items-center lg:items-start">
            ...
            <p className="text-gray-600 text-center lg:text-left leading-relaxed max-w-sm">
              Découvrez l'innovation et laissez-vous inspirer par nos solutions créatives qui 
              <span className="font-semibold text-yellow-600"> transforment les idées en réalité</span>.
            </p>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mt-6 p-3 bg-yellow-50 rounded-lg border border-yellow-200">
              <div className="flex items-start gap-2 text-xs text-gray-600">
                <svg className="w-4 h-4 mt-0.5 text-yellow-600 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
          ...
          <div className="lg:col-span-4">
            ...
            <div className="bg-gradient-to-r from-yellow-50 to-orange-50 p-6 rounded-xl border border-yellow-200 mb-6">
              <p className="text-sm text-gray-700 mb-4 leading-relaxed">
                Recevez par e-mail la newsletter Light Bulb : Découvrez en avant-première les 
                <span className="font-semibold text-yellow-700"> nouveautés et innovations</span>. 
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-pink-600 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  href="#youtube" 
                  className="group bg-white hover:bg-red-50 p-3 rounded-xl shadow-sm hover:shadow-md border border-gray-200 hover:border-red-200 transition-all duration-200 hover:scale-110" 
                  aria-label="YouTube"
                >
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-red-600 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a 
                  ...
                  aria-label="TikTok"
                >
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-gray-800 transition-colors duration-200" fill="currentColor" viewBox="0 0 24 24">
